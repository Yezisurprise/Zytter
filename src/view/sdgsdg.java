...
public class sdgsdg extends JFrame{
	...
	JLabel tips,userrating,userelo;
	...
	public sdgsdg(User user,Season s) {
		...
		getContentPane().add(userelo);
		
		lblIp = new JLabel("官方上海服务器 - IP地址106.15.248.6 - 2020-03-1 08:00:00");
		lblIp.setBounds(253, 482, 471, 15);
